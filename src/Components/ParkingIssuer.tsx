                            ...
                            {data.map((item: any, index) => (
                                <div key={index} className="flex justify-between border-b border-gray-400">
                                    <div className="grid grid-cols-5 w-full">
                                        <div className="m-2"><strong>Registreringsnr:</strong>
                                            <p>{item.registrationNumber}</p>
                                        </div>
                                        <div className="m-2"><strong>Fra dato/klokkelsett:</strong>
                                            <p>{item.startTime}</p>
                                        </div>
                                        <div className="m-2"><strong>Til dato/klokkelsett:</strong>
                                            <p>{item.endTime}</p></div>
                                        <div className="m-2"><strong>Bruker:</strong>
                                            <p>{item.user.name} ({item.user.email})</p></div>
                                        <button className="bg-gray-400 p-2 rounded-md m-4"
